...
set_output_delay -clock clk -max 2.000 [get_ports {eth_state[2]}]
set_output_delay -clock clk -min 0.500 [get_ports {eth_state[2]}]


#Aqui en eth_state tu tienes que saber son Puertos de entrada solo??
set_property PACKAGE_PIN AA18 [get_ports {eth_state[1]}]
set_property IOSTANDARD LVCMOS12 [get_ports {eth_state[1]}]
#RETARDOS DE SALIDA
set_output_delay -clock clk -max 2.000 [get_ports {eth_state[1]}]
set_output_delay -clock clk -min 0.500 [get_ports {eth_state[1]}]


set_property PACKAGE_PIN AA20 [get_ports {eth_state[0]}]
set_property IOSTANDARD LVCMOS12 [get_ports {eth_state[0]}]
#RETARDOS DE SALIDA
set_output_delay -clock clk -max 2.000 [get_ports {eth_state[0]}]
set_output_delay -clock clk -min 0.500 [get_ports {eth_state[0]}]
...
#RETARDOS DE SALIDA
set_output_delay -clock clk -max 2.000 [get_ports db]
set_output_delay -clock clk -min 0.500 [get_ports db]
...
set_input_delay -clock clk -max 3.000 [get_ports sw]
set_input_delay -clock clk -min 1.000 [get_ports sw]
